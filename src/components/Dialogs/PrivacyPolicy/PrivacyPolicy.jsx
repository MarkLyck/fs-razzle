...
import { LegalContainer } from '../TermsOfService/styles'
  ...
  <Dialog fullScreen open={open} onClose={hideTerms} transition={Transition}>
    <AppBar style={{ background: theme.colors.gray }}>
      <Toolbar>
        ...
        <h3 style={{ marginLeft: '16px' }}>Privacy Policy</h3>
      </Toolbar>
    </AppBar>
    <LegalContainer>
      <p>
        When you register an account on our website or application, as part of the process, we collect the personal
        information you give us such as your name, country and email address.<br />
        <br />
      ...
      <p>
        ...
        other way, we imply that you consent to our collecting it and using it for that specific reason only.<br />
        <br />
      ...
      <p>
        ...
        complete, your purchase transaction information is deleted.<br />
        <br />
        All direct payment gateways adhere to the standards set by PCI-DSS as managed by the PCI Security Standards
        Council, which is a joint effort of brands like Visa, MasterCard, American Express and Discover.<br />
        <br />
      ...
      <p>
        ...
        extent necessary to allow them to perform the services they provide to us.<br />
        <br />
        ...
        your personal information will be handled by these providers.<br />
        <br />
        ...
        which that service provider or its facilities are located.<br />
        <br />
        ...
        disclosure under United States legislation, including the Patriot Act.<br />
        <br />
      ...
      <p>
        ...
        sure it is not inappropriately lost, misused, accessed, disclosed, altered or destroyed.<br />
        <br />
      ...
      <p>
        ...
        information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it.<br />
        <br />
