...
const HomeLoader = () => (
    <div style={{ position: 'relative' }}>
        ...
        <TextBlock>
            ...
            before they go up. 90% of the times we made such an estimate, it proved to be successful in the long run.
            ...
            491.27%* vs. the S&P500's 176%. It is based on groundbreaking technology, which really makes a difference for
            our members. Typically, when you invest in stocks, your basic expectation is to receive 6-7% p.a. on average.
            Usually a fund product will provide you a risk adjusted, long-term return in this neighborhood. Or, if it is a better
            performing fund, demand very high fees.<br/><br/>
