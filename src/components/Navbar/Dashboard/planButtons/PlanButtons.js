...
const PlanButtons = ({ selectedPlan, actions }) => (
  <ButtonContainer key="plan-buttons">
    <Button color="primary" raised={selectedPlan === 'entry'} onClick={() => setPlan('entry', actions.selectPlan)}>
      Entry
    </Button>
    <Button color="primary" raised={selectedPlan === 'premium'} onClick={() => setPlan('premium', actions.selectPlan)}>
      Premium
    </Button>
    <Button
      color="primary"
    ...
    <Button color="primary" raised={selectedPlan === 'fund'} onClick={() => setPlan('fund', actions.selectPlan)}>
      Fund
    </Button>
  </ButtonContainer>
)
